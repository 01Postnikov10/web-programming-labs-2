...
def register():
    ...
    if request.method == "GET":
        return render_template("lab6_register.html", errors=errors)
...
def login():
    errors = []
    if request.method == "GET":
        return render_template('lab6_login.html')
    ...
    if errors:
        return render_template("lab6_login.html", errors=errors)
...
def articles_list():
    ...
    return render_template('lab6_list_articles.html', articles=my_articles, username=username, all_articles=all_articles)
...
def createArticle():
    ...
    if request.method == "GET":
        return render_template("lab6_new_article.html", errors=errors)
...
def viewArticle(article_id):
    ...
    return render_template("lab6_article.html", article=article, paragraphs=paragraphs)